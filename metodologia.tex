...
\begin{itemize}
    \item \textbf{Procedimiento:} Se cargan los archivos de audio utilizando la librería \textit{librosa}. Cada señal se divide en fragmentos de duración objetivo $t_{target} = 5$ segundos.
