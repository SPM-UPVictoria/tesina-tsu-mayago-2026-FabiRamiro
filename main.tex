...
\ifcsname abx@macro@name:delim:apa:family-given\endcsname
...
\newcommand{\NombreAlumno}{Osvaldo Fabian Ramiro Balboa}
\soulregister{\NombreAlumno}{1}
% NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyecto}{Marcado de agua digital profundo y robusto en señales de audio} 
% Noten los \\ para insertar un ENTER del texto en el encabezado. NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyectoheader}{Marcado de agua digital profundo\\ y robusto en señales de audio}
\newcommand{\NombreTSU}{Desarrollo de Software Multiplataforma}
\newcommand{\UnidadEconomica}{CINVESTAV Unidad Tamaulipas}
\newcommand{\nasesorempresaria}   {Dr. Jose Juan Garcia Hernandez}
\newcommand{\nasesorinstitucional}{Dr. Said Polanco Martagón}
\newcommand{\Matricula}           {2430098}  %SU MATRICULA
...
%\newcommand{\tipoAulaOficinaEnlacePesentacion}{el enla ce} % Otras opciones: la oficia/el aula/el enlace
...
\newcommand{\ncarreraIng}            {Ingeniería en Tecnologías de la Información e Innovación Digital}
...
% Pagina 4: Evidencias de los artículos del Estado del Arte
\clearpage
\thispagestyle{fancy}
\includepdf[pages=-]{documentosDigitalizados/Evidencias_Estado_Arte.pdf}
